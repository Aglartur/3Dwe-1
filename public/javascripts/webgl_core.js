...
function init() {
    ...
    renderer.setSize(window.innerWidth, window.innerHeight);    // take up entire space
    ...
    camera = new THREE.PerspectiveCamera(60, 1366/768, 1, 10000);       // don't worry about parameters
...
//        foo(intersects[0].object);
        intersects[ 0 ].object.material.color.setHex( Math.random() * 0xffffff );

//        flyTo(intersects[0].object);

//        setInterval(jump(intersects[ 0 ].object, new Date().getTime()), 200);
